...
namespace CrazyGames
{
    ...
    {
        private static string sitelockVersion = "1.3.0";
        ...
        static void OnRuntimeMethodLoad()
        {
            ...
            // check if the game is running on one of the dev's domains, and cancel sitelocking if it is
            {
                ...
                if (IsValidHost(whitelistedDevDomains))
                {
                    return;
                }
            }
